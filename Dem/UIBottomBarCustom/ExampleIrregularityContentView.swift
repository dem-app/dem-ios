...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = UIColor.init(red: 244/255.0, green: 101/255.0, blue: 33/255.0, alpha: 1.0)
    ...
    public override func selectAnimation(animated: Bool, completion: (() -> ())?) {
        ...
        view.backgroundColor = UIColor.init(red: 244/255.0, green: 101/255.0, blue: 33/255.0, alpha: 1.0)
